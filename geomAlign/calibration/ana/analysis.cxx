...
* STATIC VARIABLES
*/
static const int NUMBER_OF_FILES = 1025;
static const double PT_CUT = 0.5;
...
//      if(fabs(dcaZ)>1.) continue;
      float pt = t->pt[j];
      if( pt < PT_CUT) continue;       /// select good quality track from TPC center
