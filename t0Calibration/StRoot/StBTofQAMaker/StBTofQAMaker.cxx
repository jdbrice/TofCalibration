...
//		//	BTof time resolution histograms
		hBTofTimeResTray = new TH2F("BTofTimeRes_vs_Tray","BTof time resolution vs Tray",120,1,121,1000,-10.,10.);
		...
		hZVertex = new TH1F("zvertex","Z Vertex", 10000, -100,100);
...
//			cout<<"p,dedx: "<<p<<", "<<dedxx<<endl;
			...
			if(mTofTrait.pathLength() > 0) {
				...
				if (fabs(mTrack->nSigmaPion())<2. && p>0.3 && p<0.6) {
					...
					//cout << "TRAY: " << tray << " TIMING: " << (TOF_meas-TOF_expected) << endl;
